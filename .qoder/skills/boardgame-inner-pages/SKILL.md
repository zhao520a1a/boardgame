...
description: "桌游笔记内页图生成。生成4张内页（教学页/解析页/场景页/技巧页），构成完整滑动阅读体验，风格与封面统一。当用户需要生成桌游笔记内页、图文内容页、小红书滑动图时调用。关键词：内页设计、教学图、场景图、技巧图、滑动图。"
---

# 内页图生成

> 职责：生成 P2-P5 共 4 张内页，与封面（P1）构成完整的 5P 滑动阅读体验。
...
| 页码 | 类型 | 内容 | 核心目的 |
|------|------|------|---------|
| P1 | 封面 | （来自 cover-design） | 吸引点击 |
| P2 | 教学页 | N 步学会 / 快速教学 | 降低门槛 |
| P3 | 解析页 | 为什么好玩 / 核心刺激点 | 激发兴趣 |
| P4 | 场景页（暂时跳过） | 真实游戏场景 | 场景代入 |
| P5 | 技巧页 | 进阶技巧 / 隐藏玩法 | 驱动收藏 |
...
1. 根据规则摘要，提炼 P2 的 3-5 步教学内容
2. 提炼 P3 的 1-2 个核心刺激点
3. 确定 P4 场景类型
4. 设计 P5 的 2-4 个进阶技巧
5. 逐页生成图片，保存到游戏目录
6. 展示 4 张内页预览，确认风格一致性
